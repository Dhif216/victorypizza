      ...
      <div className={`min-h-screen flex items-center justify-center ${
        ...
        <div className={`w-full max-w-md p-8 rounded-2xl shadow-2xl ${
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white font-bold py-3 px-6 rounded-lg transition-all shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
            >
            ...
            <div className={`text-center text-sm ${theme === 'light' ? 'text-gray-600' : 'text-gray-400'}`}>
              ...
              <p className="text-xs mt-2 text-amber-600">{language === 'fi' ? '⚠️ Vaihda salasana tuotannossa!' : '⚠️ Change password in production!'}</p>
            </div>
          </form>
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        {loading && (
          <div className="text-center py-12">
            <RefreshCw className={`w-12 h-12 mx-auto mb-4 animate-spin ${theme === 'light' ? 'text-amber-500' : 'text-amber-400'}`} />
            <p className={theme === 'light' ? 'text-gray-600' : 'text-gray-400'}>
