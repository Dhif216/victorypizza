    ...
    >
      <div className="flex gap-4">
        ...
        <div className="flex-1 p-6 flex flex-col justify-between">
          ...
          {/* Pricing */}
          <div className={`flex justify-between items-center gap-6 pt-4 mt-4 border-t ${
            ...
            <button
              ...
              className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white px-6 py-2 rounded-lg transition-all flex items-center gap-2 shadow-lg font-semibold"
            >
