        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-16">
          ...
          <div>
            <div className="mb-8">
              <div className="flex items-center gap-3 mb-6">
                <div>
                  ...
                  <p className="text-green-400 italic tracking-widest">PIZZA</p>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <a href="tel:00358-0468420302" className={`flex items-start gap-4 hover:text-green-400 transition-colors group ${
              ...
              <a href="mailto:victroy.pizza.fi@gmail.com" className={`flex items-start gap-4 hover:text-green-400 transition-colors group ${
                theme === "light" ? "text-black/80" : "text-white/80"
              }`}>
                <div className="w-12 h-12 bg-gradient-to-br from-green-500/20 to-green-600/20 rounded-full flex items-center justify-center border border-green-500/30 group-hover:border-green-500 transition-all flex-shrink-0">
              ...
              <div className={`flex items-start gap-4 ${
                ...
                <div className="flex flex-col pt-1">
                  ...
                  <div className="text-green-400">11:00 - 22:00</div>
                </div>
              </div>
            </div>
          </div>
