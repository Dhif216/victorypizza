...
export default function App() {
  ...
  const handleShowPrivacyPolicy = () => {
    console.log('handleShowPrivacyPolicy called - setting modal to true');
    setShowPrivacyModal(true);
    console.log('showPrivacyModal state should now be true');
  };

  const handleClosePrivacyModal = () => {
    console.log('handleClosePrivacyModal called - setting modal to false');
